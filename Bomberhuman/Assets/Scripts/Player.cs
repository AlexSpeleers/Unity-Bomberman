...
public class Player : MonoBehaviour
{
    ...
    void DropBomb()
    {
        ...
        {
            GameObject.Instantiate(playerBrain.bombPrefab, new Vector3(Utils.RoundToInt(transform.position.x),Utils.RoundToInt(transform.position.y), Utils.RoundToInt(transform.position.z)),
                Quaternion.identity);
